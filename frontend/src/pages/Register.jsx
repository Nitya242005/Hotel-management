...
export default function Register() {
  ...
  return (
    <div className="relative grid min-h-screen items-center bg-cover bg-center bg-fixed lg:grid-cols-12 overflow-hidden select-none bg-ivory">
      ...
      {/* ---------- Right Side: Redesigned Glassmorphic Register Card ---------- */}
      <section className="relative z-10 flex justify-center px-4 py-8 sm:px-12 lg:col-span-5 lg:px-8 xl:px-16 min-h-screen items-center">
        ...
        <div className="relative z-10 flex w-full max-w-[430px] items-center justify-center py-6">
          ...
          <div className="relative z-10 w-full rounded-3xl glass-luxury-card p-8 sm:p-10 border border-white/60 animate-fade-up">
            ...
            {/* Error Message */}
            {error && (
              <div className="mb-4 rounded-xl border border-red-200 bg-red-50/80 px-4 py-3 text-xs text-red-800 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
              ...
              <div className="mb-4 flex flex-col">
                <label className="mb-1.5 font-sans text-[10px] font-bold uppercase tracking-[0.2em] text-bronze-soft">
                  Full Name
                </label>
                <div className="flex items-center gap-3 rounded-xl border border-beige-warm bg-ivory/60 px-4 transition-all duration-300 focus-within:border-gold-champagne focus-within:bg-white focus-within:shadow-[0_0_15px_rgba(212,168,79,0.12)]">
                  <UserIcon className="text-bronze-soft/60" />
                  <input
                    type="text"
                    value={name}
                    ...
                    autoComplete="name"
                    required
                    className="flex-1 bg-transparent py-3 text-sm text-brown-espresso outline-none placeholder:text-brown-espresso/30 font-sans"
              ...
              <div className="mb-6 flex flex-col">
                ...
                <div className="flex items-center gap-3 rounded-xl border border-beige-warm bg-ivory/60 px-4 transition-all duration-300 focus-within:border-gold-champagne focus-within:bg-white focus-within:shadow-[0_0_15px_rgba(212,168,79,0.12)]">
                  ...
                  >
                    <EyeIcon open={showConfirm} className="text-bronze-soft/60" />
                  </button>
                </div>
              </div>
              ...
              >
                {loading ? "Creating Account…" : "Register Portal Access"}
              </button>
            </form>

            {/* Redirection */}
            <p className="mt-6 text-center font-sans text-xs text-brown-espresso/60">
